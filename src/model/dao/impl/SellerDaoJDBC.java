...
public class SellerDaoJDBC implements SellerDao {
    ...
    @Override
    public void insert(@NotNull Seller seller) {
    ...
    @Override
    public Seller findById(@NotNull Integer id) {
        PreparedStatement statement = null;
    ...
    @Override
    public List<Seller> findByDepartment(@NotNull Department department) {
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        try {
            statement = conn.prepareStatement(
    ...
    // Privates
    private @NotNull Seller instantiateSeller(@NotNull ResultSet resultSet, Department department) throws SQLException {
